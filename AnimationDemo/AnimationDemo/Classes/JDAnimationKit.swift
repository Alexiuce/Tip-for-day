...
public protocol JDAnimationNode : class{
    ...
    func makeChangeBgColor(_ color: NSColor, duration: Double, spring: Bool, springConfig: JDSpringConfig, delay: Double, key: String, timing: JDTimingFunction) -> POPAnimation
    
    func changeBgColor(_ color: NSColor, duration: Double, spring: Bool, springConfig: JDSpringConfig, delay: Double, key: String, timing: JDTimingFunction) -> JDAnimationNode
...
extension JDAnimationNode{
    ...
    public var didStartBlock: JDLayerAnimationStartBlock? {
        ...
        set {
            objc_setAssociatedObject(self as? NSView, &JDAssociatedKeys.didStartBlockKey, ClosureLayerWrapper(newValue), .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
        }
    }
    ...
    public func makeChangeBgColor(_ color: NSColor, duration: Double = 0.5, spring: Bool = false, springConfig: JDSpringConfig = .JDSpringConfigDefault(), delay: Double = 0, key: String = "backgroundTo", timing: JDTimingFunction = .none) -> POPAnimation {
    ...
    public func changeBgColor(_ color: NSColor, duration: Double = 0.5, spring: Bool = false, springConfig: JDSpringConfig = .JDSpringConfigDefault(), delay: Double = 0, key: String = "backgroundTo", timing: JDTimingFunction = .none) -> JDAnimationNode {
...
extension NSView :  JDAnimationNode{
    ...
    public func changeAnchorPoint(_ x: CGFloat, y: CGFloat, delay: Double = 0) -> JDAnimationNode{
        ...
        self._executeAfter(delay) { () -> () in
            ...
            newPoint = newPoint.applying((self.layer?.affineTransform())!)
            oldPoint = oldPoint.applying(self.layer!.affineTransform())
