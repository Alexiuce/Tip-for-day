...
//@property (nonatomic, assign)    BOOL  hugeFile;
...
//源站文件独立于bucket的权限
typedef NS_ENUM(NSInteger, COSFileAuthorityType)
{
    /**采用bucket的权限 */
    eInvalidFileAuth = 0,
    /**文件私有读写的权限 */
    eWRPrivateFileAuth = 1,
    /**文件私有写公有读的权限 */
    eWPrivateRPublicFileAuth = 2,
};
...
//文件读写权限
@property(nonatomic,assign) COSFileAuthorityType authorityType;
//Custom_headers数据集合
